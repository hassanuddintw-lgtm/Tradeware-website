...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        /* Tradeware Group: white, red, navy */
        cinematic: {
          base: "#ffffff",
          elevated: "#f8fafc",
          charcoal: "#f1f5f9",
      ...
      boxShadow: {
        'cyan-glow': '0 0 32px -8px rgba(220, 38, 38, 0.25)',
        'cyan-glow-lg': '0 0 48px -12px rgba(220, 38, 38, 0.35)',
        'mdk-card': '0 1px 3px rgba(0,0,0,0.06), 0 4px 24px -4px rgba(0,0,0,0.08)',
        'mdk-card-hover': '0 8px 28px -6px rgba(0,0,0,0.12), 0 0 0 1px rgba(220,38,38,0.1)',
      },
      borderRadius: {
