      ...
      <div className="container-custom relative z-10">
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-6 gap-3 md:gap-4 max-w-5xl mx-auto">
          {journeySteps.map(({ step, label }) => (
            ...
            >
              <span className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-red-500/10 border border-red-500/20 text-cyan-400 text-sm font-bold mb-3 shrink-0 animate-float-slow icon-glow-hover icon-pulse-hover">
                {step}
              </span>
