      ...
      <div className="container-custom relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-3xl mx-auto mb-5 md:mb-6 text-left">
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3 sm:p-4">
              ...
              <ul className="space-y-1 text-[11px] sm:text-xs text-slate-300 list-none">
                <li className="flex items-start gap-1.5"><span className="text-red-500/80 mt-0.5 shrink-0" aria-hidden="true">✔</span> Buyers importing vehicles</li>
                <li className="flex items-start gap-1.5"><span className="text-red-500/80 mt-0.5 shrink-0" aria-hidden="true">✔</span> Dealers, exporters, and serious individual buyers</li>
                <li className="flex items-start gap-1.5"><span className="text-red-500/80 mt-0.5 shrink-0" aria-hidden="true">✔</span> Those comfortable with auction-based purchases</li>
                <li className="flex items-start gap-1.5"><span className="text-red-500/80 mt-0.5 shrink-0" aria-hidden="true">✔</span> Buyers ready for deposits and documentation</li>
              </ul>
            </div>
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] p-3 sm:p-4">
        ...
        >
          <a
            ...
            className="card p-3 sm:p-4 md:p-5 flex items-center gap-2.5 sm:gap-3 hover:border-red-500/20 transition-colors cursor-pointer min-w-0"
          >
            <div className="shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg border border-red-500/20 bg-red-500/5 flex items-center justify-center">
              <Phone className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-red-500" />
            </div>
            <div className="text-left min-w-0">
              <div className="text-[8px] sm:text-[9px] font-semibold text-red-500/90 uppercase tracking-wider">Direct Line</div>
          ...
          {siteConfig.contact.emails.map((email) => (
            <a
              key={email}
              href={`mailto:${email}`}
              className="card p-3 sm:p-4 md:p-5 flex items-center gap-2.5 sm:gap-3 hover:border-red-500/30 transition-colors cursor-pointer min-w-0 bg-white/5 border-white/10"
            >
              <div className="shrink-0 w-9 h-9 sm:w-10 sm:h-10 rounded-lg border border-red-500/30 bg-red-500/10 flex items-center justify-center">
                <Mail className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-red-500" />
              </div>
              <div className="text-left min-w-0">
                <div className="text-[8px] sm:text-[9px] font-semibold text-red-500/90 uppercase tracking-wider">Email</div>
