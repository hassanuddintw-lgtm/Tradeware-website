            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-10 2xl:gap-10 items-center">
              <div className="min-w-0 order-2 lg:order-1">
                ...
                <h2 id="trust-heading" className="heading-section-mdk text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-slate-900 mb-3 md:mb-4 tracking-tight">
                  Absolute <span className="text-red-600">Certainty</span>
                </h2>
                ...
                >
                  {trustPoints.map((point, i) => (
                    <li
                      ...
                      role="listitem"
                    >
                      <CheckCircle2 className="h-3 w-3 sm:h-3.5 sm:w-3.5 shrink-0 text-red-600" aria-hidden="true" />
                      <span>{point}</span>
                    </li>
                  ))}
                </ul>
                  ...
                  {stats.map((s) => {
                    ...
                    return (
                      <div
                        ...
                        role="listitem"
                      >
                        <Icon className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-red-600 mb-1.5 sm:mb-2 shrink-0" aria-hidden="true" />
                        <div className="text-lg sm:text-xl font-bold text-slate-900 break-words">{s.value}</div>
                        <div className="text-[8px] sm:text-[9px] font-semibold text-red-600 uppercase tracking-wider break-words">{s.label}</div>
                      </div>
                    );
                  })}
                </div>
