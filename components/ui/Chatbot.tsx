              ...
              <div className="p-3 border-t border-white/[0.06] flex gap-2 overflow-x-auto">
                {quickReplies.map((r) => (
                  <button
                    ...
                    className="px-3 py-1.5 text-[11px] rounded-full bg-white/5 text-zinc-400 hover:bg-red-500/10 hover:text-red-400 transition-colors whitespace-nowrap cursor-pointer"
                  >
                    {r.label}
                  </button>
                ))}
