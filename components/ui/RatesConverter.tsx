              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex justify-center">
                  <button
                    type="button"
                    onClick={swap}
                    className="p-2 rounded-full border border-white/10 bg-white/5 text-red-500 hover:bg-cyan-500/10 transition-colors cursor-pointer"
                  >
                ...
                <div className="pt-3 border-t border-white/[0.06] flex items-center justify-between">
                  ...
                  <button type="button" onClick={refreshRates} className="p-1.5 rounded text-zinc-500 hover:text-red-500 transition-colors cursor-pointer">
